      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="signup.php">Home</a></li>
...
<form action="signin.php" method="POST">
 <input class="form-control" type="email" name="email" placeholder="Enter UserName"> <br>
...
if(isset($_POST['submit']))
{
  if(!empty($_POST['email'])||isset($_POST['email']) && (!empty($_POST['pass'])||isset($_POST['pass'])))
  {
	...
	$pass=$_POST['pass'];	
	$passhash = md5($pass);
	$query="SELECT id FROM users WHERE email='$email' AND pass='$passhash'";
